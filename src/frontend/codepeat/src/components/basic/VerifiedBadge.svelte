<!--
@component
Verified badge: a filled check badge used to mark official CodePeat accounts.
-->
<script lang="ts">
    let {class: className = "size-5", label = "Verifiziert"}: {class?: string; label?: string} = $props();
</script>
